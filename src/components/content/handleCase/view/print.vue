<template>
  <div>
    ...
    <div class="bottom-btn">
      <button type="button" class="submit" @click="submit">打印</button>
    </div>
  </div>
</template>
<script>
export default {
  ...
  methods: {
    submit() {
      let param = this.form
      param.casenum = this.$route.query.serialNO
      param = JSON.stringify(param)
      
      this.$http.post(process.env.ROOT_API + 'recandappform/addObj', {addRecandappformString: param}, {emulateJSON: true})
      .then(
        res => {
